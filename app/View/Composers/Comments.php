...
class Comments extends Composer
{
    ...
    public function title()
    {
        return sprintf(
            ...
            _nx('%1$s response to &ldquo;%2$s&rdquo;', '%1$s responses to &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'gorilla'),
            get_comments_number() === 1 ? _x('One', 'comments title', 'gorilla') : number_format_i18n(get_comments_number()),
            get_the_title()
        );
    }
    ...
    public function previous()
    {
        ...
        return get_previous_comments_link(
            __('&larr; Older comments', 'gorilla')
        );
    }
    ...
    public function next()
    {
        ...
        return get_next_comments_link(
            __('Newer comments &rarr;', 'gorilla')
        );
    }
